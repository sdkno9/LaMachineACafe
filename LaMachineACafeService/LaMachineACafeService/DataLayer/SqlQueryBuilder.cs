...
namespace LaMachineACafe.Common
{
    public class SqlQueryBuilder
    {
        ...
        public SqlQueryBuilder Where(string fieldName, object value, SqlComparisonEnum comparison)
        {
            //Let's keep it simple, only one condition is allowed
            WhereCondition = new WhereCondition(fieldName, TableName, value, comparison);
            return this;
        }
